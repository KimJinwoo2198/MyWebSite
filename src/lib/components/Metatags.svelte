<script lang="ts">
  export let title = 'Kim Jinwoo';
  export let google_analytics = 'G-JEHCBZEX1R';
  export let description = "Hi! I'm KimJinwoo, and I build and make cool stuffs";
...
<svelte:head>
  ...
  <meta name="twitter:site" content="kimjinwoo.me" />
